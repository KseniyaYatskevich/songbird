const movieData = [
  [
    ...
    },
    {
      ...
      year: '1973',
      description: 'Фильм рассказывает об инженере-изобретателе Шурике, создавшем машину времени, которая открывает двери в XVI век — во времена Ивана Грозного, в результате чего царь оказывается в советской Москве, а его тёзка — управдом Иван Бунша вместе с вором-рецидивистом Жоржем Милославским — в палатах царя.',
  ...
  [
    ...
    },
    {
      ...
      name: 'Ночной дозор',
      year: '2004',
      description: 'Российский фильм режиссёра Тимура Бекмамбетова в жанре городского фэнтези, снятый по мотивам одноимённого романа Сергея Лукьяненко. Фильм рассказывает о тайной борьбе светлых и тёмных мистических сил в современной Москве.',
    ...
    },
    {
      ...
      year: '2015',
      description: 'Фильм повествует о судьбе легендарной женщины-снайпера 25-й Чапаевской стрелковой дивизии Красной армии, Героя Советского Союза, лейтенанта Людмилы Павличенко, уничтожившей в годы Великой Отечественной войны 309 солдат и офицеров войск нацистской Германии.',
  ...
  [
    ...
    },
    {
      ...
      year: '2001',
      description: 'Британско-американский фэнтезийный фильм 2001 года режиссёра Криса Коламбуса по сценарию Стивена Кловза. Первый фильм франшизы о мальчике-волшебнике Гарри Поттере, экранизация одноимённого романа Джоан Роулинг.',
  ...
  [
    {
      ...
      name: 'Король лев',
      year: '1994',
      description: 'Классический полнометражный мультфильм, выпущенный студией Диснея, о львёнке по имени Симба, которому предстоит пройти через предательство и изгнание, найти преданных друзей и свою любовь, а также стать истинным Королём.',
    ...
    },
    {
      ...
      name: 'Аладдин',
      year: '1992',
      description: 'Мультипликационный фильм, выпущенный в прокат киностудией "Walt Disney Pictures" в 1992 году и снятый по мотивам известной сказки об Аладдине из "1001 ночи". Некоторые персонажи и сюжетные повороты основаны на фильме "Багдадский вор" (1940) и мультфильме "1001 арабская ночь"(1959)',
    ...
    },
    {
      ...
      name: 'Город героев',
      year: '2014',
      description: 'Действие происходит в вымышленном метрополисе Сан-Франсокио — месте, где смешались американская и японская культуры. 14-летний вундеркинд, Хиро Хамада, большой любитель боёв ботов — подпольных игр на деньги, цель которых — при помощи своего боевого робота победить робота соперника.',
    ...
    },
    {
      ...
      year: '2004',
      description: 'Полнометражный мультипликационный фильм студии "Мельница" и первый мультфильм из цикла "Три богатыря". В древнем русском городе Ростове у попа в семье родился сын, и его назвали Алёшей, а по отцу — Поповичем. Когда он вырос, то стал богатырём, который всё время попадал в неприятности и даже был прозван "непутёвым". ',
    ...
    },
    {
      ...
      name: 'Зверополис',
      year: '2016',
      description: 'Американский компьютерно-анимационный комедийно-приключенческий фильм в формате 3D. Мультфильм повествует о Зверополисе — современном городе, населённом антропоморфными животными. Как и любой мегаполис, Зверополис разделён на районы, каждый из которых полностью повторяет естественную среду обитания его жителей. ',
  ...
  [
    {
      ...
      name: 'Игра престолов',
      year: '2011-2019',
      description: 'Американский телесериал в жанре фэнтези, основанный на цикле романов «Песнь Льда и Огня» Джорджа Р. Р. Мартина. Действие «Игры престолов» происходит в вымышленном мире, напоминающем средневековую Европу. В сериале одновременно действует множество персонажей и развивается несколько сюжетных линий. ',
    ...
    },
    {
      ...
      name: 'Ведьмак',
      year: '2019-',
      description: 'Американо-польский фэнтезийный телесериал, снятый по мотивам одноименной серии романов Анджея Сапковского. Ведьмак Геральт из Ривии, мутант и убийца чудовищ, изо всех сил старается найти своё место в мире, где люди часто оказываются намного хуже монстров.',
    ...
    },
    {
      ...
      name: 'Друзья',
      year: '1994-2004',
      description: 'Американский комедийный телесериал, повествующий о жизни шестерых друзей. Признан одним из лучших комедийных сериалов в истории американского телевидения и стал одним из наиболее знаменитых проектов 1990-х годов.',
  ...
  [
    ...
    },
    {
      ...
      name: 'Мамма Мия!',
      year: '2008',
      description: 'Действие фильма происходит на греческом острове Калокаири. 20-летняя Софи Шеридан собирается выйти замуж за Ская. Омрачает будущий праздник одно — Софи воспитывала её мать, Донна, и главная героиня не знает, кто её отец.',
    ...
    },
    {
      ...
      name: 'Бурлеск',
      year: '2010',
      description: 'Молодая амбициозная девушка Али с чудесным голосом отправляется из маленького городка в Лос-Анджелес, где хочет найти свою любовь, семью и успех. Она находит работу в нео-бурлеск-клубе, где знакомится с Тэсс, бывшей танцовщицей, которая борется за свой клуб и становится своего рода наставником для Али. ',
    ...
    },
    {
      ...
      name: 'Зверопой',
      year: '2016',
      description: 'Американский компьютерно-анимационный комедийный мюзикл производства компании Illumination. В мире человекоподобных животных коала Бастер Мун владеет театром, являясь фанатом шоу-бизнеса. Он любит эстраду с тех пор, как отец в первый раз взял его ещё ребёнком на музыкальное шоу.',
